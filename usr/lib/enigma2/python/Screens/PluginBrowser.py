...
config.pluginfilter.bootlogos = ConfigYesNo(default=True)
...
class PluginDownloadBrowser(Screen):
    ...
    def createPluginFilter(self):
        ...
        if config.pluginfilter.bootlogos.value:
        ...
        self.PLUGIN_PREFIX2.append(self.PLUGIN_PREFIX + 'feeds')
...
class PluginFilter(ConfigListScreen, Screen):
    ...
    def createSetup(self):
        ...
        self.list.append(getConfigListEntry(_('bootlogos'), config.pluginfilter.extensions, _('This allows you to show extensions modules in downloads')))
